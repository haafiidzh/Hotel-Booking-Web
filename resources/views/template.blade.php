...
<head>
    ...
    {{-- <link rel="stylesheet" href="{{ asset('admin/dist/css/modern-AdminLTE.min.css') }}"> --}}
      ...
      <span class="brand-text font-weight-light">AdminLTE 3</span>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('admin/dist/logo-jadi.png') }}" class="img-circle elevation-1"
                            alt="User Image">
                    </div>
                    <div class="info">
              ...
              <p>Tambah User</p>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="/kamar/tambah" class="nav-link">
                                            <i class="nav-icon fas fa-plus-circle"></i>
                                            <p>Tambah Kamar</p>
                                        </a>
                                    </li>
                        ...
                        @can('Resepsionis')
                            <li class="nav-item">
                                <a href="/akun/resepsionis" class="nav-link">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="/customer/tambah" class="nav-link">
                                            <i class="nav-icon fas fa-plus-circle"></i>
                                            <p>Tambah Tamu</p>
                                        </a>
                                    </li>
